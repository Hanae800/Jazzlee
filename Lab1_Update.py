...
#%%
# string
print ("Hello Program my name is Hanae and I am 23 years old.")
# 
print(7)
# float
print (1.000001)
...
#%%
 ...
 def compare(numx,numy):
  if numx == numy:
    print(str(numx) + " is equal to " + str(numy))
  elif numx > numy:
    print (str(numx) + " is greater than " + str(numy))
  else:
    print (str(numx) + " is less than " + str (numy))
